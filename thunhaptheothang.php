...
<html>
  ...
  <body>
    ...
    <div id="rightContent">
      ...
      <?php 
      require_once("/var/www/html/admin/model/thunhaptheothang.php");
      $list_nam = lay_nam();
      ?>
    </br>
    ...
    if ($row >0) { ?>
    <div id="piechart" style="width: 650px; height:550px;"></div>
    ...
    // Load google charts
      ...
      var options = {'title':tit, width: 800,
        height: 500,
