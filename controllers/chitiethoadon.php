<?php
include_once('/var/www/html/admin/model/chitiethoadon.php');
	...
	if($command=="search"){
		...
		if ($search!==""){
			...
			if ($num>0){
				...
				header("Location:/admin/timkiemChiTietHoaDon.php?keyword=$search");
			}else {
			...
			header("Location:/admin/chitiethoadon.php");
		}
	}
